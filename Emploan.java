...
public class Emploan  { public static void main(String[] args)
{ PermanentEmployee permanentemployee = new PermanentEmployee(101,"Priya",22000.0);
        TemporaryEmployee temporaryemployee = new TemporaryEmployee(102,"Lakshmii",6,1000);
        ...
        System.out.println("Permanent Employee Salary:"+temporaryemployee.getSalary());
